...
namespace HunterW_BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,TicketId,PropertyName,OldValue,NewValue,Updated")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,TicketId,PropertyName,OldValue,NewValue,Updated")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
