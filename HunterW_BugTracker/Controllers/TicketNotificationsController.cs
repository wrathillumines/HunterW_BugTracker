...
namespace HunterW_BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,TicketId,RecipientId,SenderId,Created,NotificationBody,Subject,HasBeenRead")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,RecipientId,SenderId,Created,NotificationBody,Subject,HasBeenRead")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
