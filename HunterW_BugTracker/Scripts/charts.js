		...
		switch (type) {
			case 'morris-line':
				Morris.Line({
					...
					ykeys: ['a'],
					labels: ['Series A'],
					lineColors: ['#1c8ed7', '#FED42A', '#20c05c', '#FF5722'],
					pointSize: 0,
					pointStrokeColors: ['#1c8ed7', '#1e59d9', '#20c05c', '#FED42A', '#FF5722'],
					lineWidth: 6,
					resize: true
				});
				break;
			...
			case 'morris-area':
				...
				Morris.Area({
					...
					lineColors: ['#1c8ed7', '#1e59d9', '#20c05c', '#FED42A', '#FF5722'],
					pointStrokeColors: ['#1c8ed7', '#1e59d9', '#20c05c', '#FED42A', '#FF5722'],
					pointSize: 0,
					fillOpacity: '0.6',
					resize: true
